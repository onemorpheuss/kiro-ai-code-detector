...
displayName: "AI Code Detector & Cleaner"
description: "Review code quality, detect signals that code was likely AI-generated (boilerplate comments, generic naming, redundant defensive code, marketing-style prose, telltale formatting), and clean up those AI traces so code reads as natural, idiomatic, project-consistent work."
keywords: ["ai-detection", "ai-generated", "ai-traces", "code-review", "code-quality", "humanize", "cleanup", "refactor", "comments", "boilerplate", "naming", "style", "linting", "ai-slop", "detector", "scrub", "normalize"]
author: "Built for Kiro"
---
